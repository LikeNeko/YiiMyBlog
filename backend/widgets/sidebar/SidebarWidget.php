    ...
    public function init()
    {
        $this->items = [
            ...
            ['label' =>'<a href=""><i class="fa fa-th-list"></i><span>内容管理</span></a>','options'=>['class'=>'nav-parent'],'items'=>[
                    ['label'=>'文章管理','url'=>['posts/index'],'items'=>[
                        ['label'=>'创建文章','url'=>['posts/create'],'visible'=>false],
                        ['label'=>'更新文章','url'=>['posts/update'],'visible'=>false],
                        ]                       
                    ],
            ...
            ['label' =>'<a href=""><i class="fa fa-user"></i><span>会员管理</span></a>','options'=>['class'=>'nav-parent'],
                'items'=>[
